========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : BinderPlugin
========================================================================


AppWizard が生成した BinderPlugin には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには BinderPlugin を構成している各ファイルの概要説明が含まれています。
...
BinderPlugin.h
	...
	CBinderPluginApp アプリケーションクラスを宣言します。

BinderPlugin.cpp
	このファイルは CBinderPluginApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) BinderPlugin.pch 
