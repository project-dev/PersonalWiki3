========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ExcelExportPlugin
========================================================================


AppWizard が生成した ExcelExportPlugin には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには ExcelExportPlugin を構成している各ファイルの概要説明が含まれています。

ExcelExportPlugin.dsp
...
ExcelExportPlugin.h
	...
	CExcelExportPluginApp アプリケーションクラスを宣言します。

ExcelExportPlugin.cpp
	このファイルは CExcelExportPluginApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。


ExcelExportPlugin.rc
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ExcelExportPlugin.pch 
