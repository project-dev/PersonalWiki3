========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : DrawerPlugin
========================================================================


AppWizard が生成した DrawerPlugin には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには DrawerPlugin を構成している各ファイルの概要説明が含まれています。
...
DrawerPlugin.h
	...
	CDrawerPluginApp アプリケーションクラスを宣言します。

DrawerPlugin.cpp
	このファイルは CDrawerPluginApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) DrawerPlugin.pch 
