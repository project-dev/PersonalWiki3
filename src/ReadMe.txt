========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : PersonalWiki
========================================================================


AppWizard が生成した PersonalWiki には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには PersonalWiki を構成している各ファイルの概要説明が含まれています。
...
PersonalWiki.h
    ...
    みます） をインクルードし、また CPWikiApp アプリケーションクラスを宣
    言します。

PersonalWiki.cpp
    このファイルは CPWikiApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\PersonalWiki.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル PersonalWiki.rc によってインクルード
    されます。

res\PersonalWiki.rc2
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、PersonalWiki.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

PWikiDoc.h, PWikiDoc.cpp - ドキュメント
    これらのファイルは CPWikiDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CPWikiDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

PWikiView.h, PWikiView.cpp - ビュー
    これらのファイルは CPWikiView クラスを含みます。
    CPWikiView オブジェクトは CPWikiDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) PersonalWiki.pch 
