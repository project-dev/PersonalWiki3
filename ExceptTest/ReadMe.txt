========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ExceptTest
========================================================================


AppWizard が生成した ExceptTest には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ExceptTest を構成している各ファイルの概要説明が含まれています。
...
ExceptTest.h
    ...
    みます） をインクルードし、また CExceptTestApp アプリケーションクラスを宣
    言します。

ExceptTest.cpp
    このファイルは CExceptTestApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ExceptTest.ico
    ...
    ルです。このアイコンはリソース ファイル ExceptTest.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、ExceptTest.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

ExceptTestDoc.h, ExceptTestDoc.cpp - ドキュメント
    これらのファイルは CExceptTestDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CExceptTestDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

ExceptTestView.h, ExceptTestView.cpp - ビュー
    これらのファイルは CExceptTestView クラスを含みます。
    CExceptTestView オブジェクトは CExceptTestDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ExceptTest.pch 
